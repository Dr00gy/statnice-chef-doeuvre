# Předmluva
V tomto docu se jedná o přípravu na státnice ve formě sekvenčních deep-dives do individuálních pojmů a jejich linkování s několika disciplínama z okruhů. Jde o způsob, jak si efektivněji vytvořit souvislosti a obecně zlepšit memory. Cílem je si nejen zapamatovat "perly", ale také nějakým způsobem porozumět dané látce. Focus na relace zejména, jelikož je to pro náš ročník 2026 jakýmsi hyperfixačním bodem v komisích... AI je použito jen pro ušetření práce s formátováním tabulek / toku myšlenek z matematických definic nebo pro psaní příkladů k vysvětlivkám, ale kontroluju ho. Zbytek je all human cognitive work.
...
WIP skok na relace protoze unarni a binarni op.
...
WIP SKOK NA ZBYTEK VYROKOVE LOGIKY
...
WIP ODKAZ NA LOGIKU KVULI UNIVERZA
...
WIP SKOK NA KONGRUENCE
WIP SKOK NA KOMBINATORIKU
WIP NA DS?
...
WIP SKOK NA POKROCILE VECI S BAZEMA PO MATICICH
...
TODO nahrad rovnítka s kongruencí
...
WIP skok pro správnou negaci k logice
...
**Limity:**
TODO bold text
Znova z posloupností
WIP skok na posloupnosti
...
WIP skok na mnoziny, relace a modulo z matiky nekde
WIP nekde skok na grafy a na algoritmy
WIP skok na OSY zásobník nebo programko idk rn
...
WIP skok na UTI a programko struktury
...
WIP skok na paměti OSY
WIP skok na struktury jako fronta a tak programku a UTI
...
WIP skok zpátky na tranzistory a tam to linknout zpátky sem
...
WIP skok zpatky na adresovani a tam link k tomuto slajdu
...
**Ethernet and IEEE**
WIP jump to LAN, WLAN,, VLAN stuff and back here
...
WIP odkaz na kartéz součin jako vyjímka
...
WIP skok na dotazování relač. DB
...
WIP skok na domény a zpátky sem
...
**GENERALIZACE je dědičnost!!!** Dál se používají další OOP termíny v kontextu tříd. WIP ZDE LINK NA OOP
...
![image](https://hackmd.io/_uploads/S1![image](https://hackmd.io/_uploads/HyxqX2vkMx.png)
